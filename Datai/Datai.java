...
public class Datai {
    ...
    public static String phone(String prefix) { return prefix + " 55 " + zfill(Integer.toString((int) (Math.random() * 10000)), 4) + " " + zfill(Integer.toString((int) (Math.random() * 10000)), 4); }

    public static String address() { return streets[(int) (Math.random() * streets.length)] + " " + Integer.toString((int) (Math.random() * 100)); }
    ...
    private static String[] fullNameNgender() {
        String name, gender;
        ...
        String[] res = {name + " " + surnames[surname1] + " " + surnames[surname2], gender};
    ...
    public static String[] fullPerson() {
        String[] nameNgender = fullNameNgender();
        return (fullPerson(nameNgender[0], nameNgender[1]));
    }
    ...
    private static String[] fullPerson(String fullName, String gender) {
        ...
        String consonantNameAcronym = new String();
        ...
        curp = nameAcronym + year.substring(2, 4) + zfill(month, 2) + zfill(day, 2) + gender + state() + consonantNameAcronym + key;
        ...
        String born = zfill(day, 2) + "-" + zfill(month, 2) + "-" + zfill(year, 4);

        // Create phone

        phone = "+52 55 " + zfill(Integer.toString((int) (Math.random() * 10000)), 4) + " " + zfill(Integer.toString((int) (Math.random() * 10000)), 4);
        ...
        String[] res = {fullName, name, surname, age, born, curp, rfc, phone, email, address};

        return res;
    }

    // Methods from Stringe.Stringe

    private static String zfill(String strNum, int size) {
